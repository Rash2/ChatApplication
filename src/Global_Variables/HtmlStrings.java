...
public interface HtmlStrings {
    ...
    String SearchPageDisplayResultEndAlreadyFriends = "</h2>\n" +
            "    <h4 style=\"font-family: sans-serif;position: relative;left: 87.5%;bottom: 45%;color: white;\">Already Friends</h4>\n" +
            "</div>\n";
